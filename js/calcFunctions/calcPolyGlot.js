...
function drawPolyglot( polyglot , ctx) {
    ...
    Ycenter = normal2range(polyglot.Ycenter,0,h);
    weight = normal2range(polyglot.weight,1,20);
    startAngle = normal2range(polyglot.startAngle,0,360);
    nPolys = normal2range(polyglot.nPolys,0,1000);
    thetaRot = normal2range(polyglot.thetaRot,0,360);
    ...
    warblePerc = normal2range(polyglot.warblePerc,0,10);
